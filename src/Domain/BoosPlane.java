...
public class BoosPlane extends Plane {
    ...
    //the move of boos plane's bullets
    public void bulletMove(){
        ...
        if (System.currentTimeMillis()-Data.enterTime>=Data.duration
                &&
                (bullets.size() == 0 || now_time - bullets.get(bullets.size() - 1).get(0).getShootTime() >= shootInterval)) {
